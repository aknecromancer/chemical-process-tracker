...
import 'batch_entry_screen.dart';
    ...
    try {
      ...
      if (mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => BatchEntryScreen(date: today),
          ),
        ).then((_) => _loadData());
      }
    } catch (e) {
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BatchEntryScreen(date: DateTime.now()),
                    ),
                  ).then((_) => _loadData());
                },
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => BatchEntryScreen(date: batch.date),
            ),
          ).then((_) => _loadData());
        },
      ),
